...
private[spark] class KubernetesSuite extends SparkFunSuite with BeforeAndAfter {
  ...
  private val GROUP_BY_MAIN_CLASS = "org.apache.spark.deploy.kubernetes" +
